...
<h2>
      <a href="index.php#welcome"><i class="fa fa-chevron-left"></i></a> eagleninja Blog
</h2>
<div class="well">
...
<div class="">
      <li style="text-align: center;">
          ...
          <a href="blogpost_challenges_mobile_advertising.php"><h3>The Challenges of Mobile Advertising</h3>
          </a>
          </div>
          <div class="blog_img">
      <div class="calendar-div-css">
          ...
          <a href="blogpost_challenges_mobile_advertising.php"></a>
          </div>
...
And yet although mobile as a share of our overall media consumption already accounts for 25%, mobile advertising as a share of advertising lags significantly, at 9.8%.
      ...
      <a class="button button-green" href="blogpost_challenges_mobile_advertising.php">Read more <i class="fa fa-chevron-right"></i></a>          
